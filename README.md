...
We evaluate our approach based on its impact on circuit behavior, monitoring coverage, and error detection effectiveness. Results show that most circuits maintain their original behavior after adding monitoring nodes. However, preserving functionality limits monitoring coverage (e.g., an average qubit coverage of 39.8\%). Despite this, our method effectively detects and localizes errors, identifying 35 out of 99 error-inducing mutations across 33 quantum circuits, with 32 mutations accurately localized.
